...
class PbteenSpider(Spider):
    ...
    start_urls = ['https://www.pbteen.com/shop/specialty-shops/fsc-feature/',
                  # For greenguard products
                  # 'https://www.pbteen.com/shop/specialty-shops/greenguard-feature/'
     ]
    def parse(self, response):
        #URL Links to each product within 'FSC' results
        #PBTeen currently has only one page of results for 'FSC' products
